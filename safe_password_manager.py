...
display.title("Safe_Password_Manager")
display.title("Created by Sakshyam Karmacharya - Ethical Hacking Batch")
...
#   Safe password manager functionalities #
...
#   display layout #
    ...
    lbl = Label(second_frame, text="Safe_Password_Manager")
    lbl.grid(column=2)
